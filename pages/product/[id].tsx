...
const Product:React.FC<Data> = ({ pizza }) => {
  ...
  const handleChange = (e:ChangeEvent<HTMLInputElement>, option: any) => {
    ...
    if (checked) {
      ...
      changePrice(-option.price);
      setExtras(extras.filter((extra: { _id: any; }) => extra._id !== option._id));
    }
  };
    ...
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        ...
        <div className={styles.ingredients}>
          {pizza.extraOptions.map((option: { _id: any; text?: any; price?: number; }) => (
